        ...
        <div class="wrapper" style='margin-top: 180px;'>
            <div class="container">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-8">
                            <div id="cyPanel" class="card-box" style="background-color: #e5ebf0;">
                                <div id="cy" ></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <h4><b class="text-muted2">Protein</b></h4>
                             <div id="onInterolog">
                             ...
                             <h4><b class="text-muted2">Interaction Table</b></h4>
                             <table id="datatable-visualization" class="table table-bordered" cellspacing="0" width="100%">
                                 <thead>
                                     <tr role="row">
                                         <th tabindex="0" rowspan="1" colspan="1" >Host</th>
                                         <th tabindex="0" rowspan="1" colspan="1" >Pathogen</th>
                                     </tr>
                                 </thead>
                                 <tbody>
                                ...
                                while(! feof($fileTabular)){
                                    ...
                                    if($line != false && $line != '\n' && trim($line) != ''){
                                        ...
                                        if(($method=="GOPred" || $method=="phyloPred") && $separatedLine[0]=="YES"){
                                            echo '<tr role="row">';
                                            echo '<td>' . $separatedLine[$index_a] . '</td>';
                                            echo '<td>' . $separatedLine[$index_b] . '</td>';
                                            echo '</tr>';
                                        } else if(!($method=="GOPred" || $method=="phyloPred")){
                                            echo '<tr role="row">';
                                            echo '<td>' . $separatedLine[$index_a] . '</td>';
                                            echo '<td>' . $separatedLine[$index_b] . '</td>';
                                            echo '</tr>';
                            ...
                            <h4><b class="text-muted2">Layout</b></h4>
                            <b>Layout:</b>
                            ...
                            <input type='color' id="colorPicker" value="#e5ebf0" />
...
<!--
        ...
        <script>
            ...
            $.getJSON(jsonFilename, function(json) {
                ...
                var tableNetwork = $('#datatable-visualization').DataTable({
                    "paging": false,
                    "scrollCollapse": true,
                    "scrollY": "22vh",
                    "info": false
               ...
               cy.on('click', 'node', function(evt){
                      ...
                      tableNetwork.search( nodeSelected.data("id") ).draw();
                      ...
                      if(method=="interolog"){
                        ...
                        if(!(nodeSelected.data("hitTaxon")==null)){
                            var externalLinksQuery= '<h6><a target="_blank" href="https://www.uniprot.org/uniprot/'+nodeSelected.data("id")+'"> Uniprot Description </a> | <a target="_blank" href="https://www.ncbi.nlm.nih.gov/protein/'+nodeSelected.data("id")+'"> RefSeq Description</a><h6>';

                            var externalLinks= '<a target="_blank" href="https://www.uniprot.org/uniprot/'+nodeSelected.data("hitName")+'"> Uniprot Description </a> | <a target="_blank" href="https://www.ncbi.nlm.nih.gov/protein/'+nodeSelected.data("hitName")+'"> RefSeq Description</a> | <a target="_blank" href="https://www.string-db.org/network/'+nodeSelected.data("hitName")+'"> STRING</a>';
                            ...
                            var taxonAndID = nodeSelected.data("hitName");
                            var arrayTaxonID = taxonAndID.split(".");

                            $('#NodeInterolog-ID').text(nodeSelected.data("id"));

                            var externalLinksQuery= '<h6><a target="_blank" href="https://www.uniprot.org/uniprot/'+nodeSelected.data("id")+'"> Uniprot Description </a> | <a target="_blank" href="https://www.ncbi.nlm.nih.gov/protein/'+nodeSelected.data("id")+'"> RefSeq Description</a><h6>';

                            var externalLinks= '<a target="_blank" href="https://www.uniprot.org/uniprot/'+nodeSelected.data("AltHitName")+'"> Uniprot Description </a> | <a target="_blank" href="https://www.string-db.org/network/'+nodeSelected.data("hitName")+'"> STRING</a>';

                             var TaxonLinks= '<a target="_blank" href="https://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?id='+arrayTaxonID[0]+'"> '+arrayTaxonID[0]+'</a>';
                            
                            document.getElementById("interolog-hitName").innerHTML = nodeSelected.data("hitName")+"  "+externalLinks;
                            document.getElementById("interolog-hitTaxon").innerHTML = TaxonLinks;
                            document.getElementById("interolog-ID").innerHTML = nodeSelected.data("id")+"  "+externalLinksQuery;
                            //$('#onNodeInterologSelected').modal();


                            document.getElementById("NodeInterolog-hitName").innerHTML = nodeSelected.data("id")+"  "+externalLinks;
                            $('#NodeInterolog-hitTaxon').text(TaxonLinks);
               ...
               cy.on('click', 'edge', function(evt){
                      ...
                      if(method=="interolog"){
                          ...
                          $('#EdgeInterolog-authorName').text(edgeSelected.data("author"));
                      } else if(method=="domainPred"){
