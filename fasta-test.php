...
if($correctFastaFileHost > 5 && $interologType <= 2){
	...
	if($correctFastaFileHost < 7){
        $blastTypeHost ="blastp";
    } else {
        $blastTypeHost ="blastx";
    }
}
...
if($correctFastaFilePathogen > 5 && $interologType >= 2 ){
	...
	if($correctFastaFilePathogen < 7){
        $blastTypePathogen ="blastp";
    } else {
        $blastTypePathogen ="blastx";
    }
}
...
if($proceed){
    if($module=="Interolog"){
        if($numberHost>50000 && $numberPathogen>25000){
            $errorFasta = 6;
        } else if($numberHost>50000){
            $errorFasta = 4;
        } else if($numberPathogen>25000){
            $errorFasta = 5;
        }


    } else if ($module=="Domain-based") {
        if($numberHost>50000 && $numberPathogen>5000){
            $errorFasta = 6;
        } else if($numberHost>50000){
            $errorFasta = 4;
        } else if($numberPathogen>5000){
            $errorFasta = 5;
        }

    } else if ($module=="GOsim") {
        if($numberHost>2000 && $numberPathogen>1000){
            $errorFasta = 6;
        } else if($numberHost>2000){
            $errorFasta = 4;
        } else if($numberPathogen>1000){
            $errorFasta = 5;
        }
