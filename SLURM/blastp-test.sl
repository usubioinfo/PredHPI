...
diamond blastp --query Demo.fasta --db /home/shared_dbs_MODS/bioinfo_dbs/hpidb  --outfmt 6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qcovhsp qcovhsp   --out slurm_test.txt --threads $SLURM_NTASKS
